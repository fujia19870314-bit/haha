...
export class DailyPromptHandler {
     ...
     * 获取指定阶段的所有提示词
     */
    async getAllPrompts(stage, isAnniversary = false) {
        try {
     ...
     * 获取默认提示词
     */
    getDefaultPrompt(stage, isAnniversary) {
        if (isAnniversary) {
...
//# sourceMappingURL=get-daily-prompt.js.map