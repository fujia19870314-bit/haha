// 系统提示词模块
export var PromptTemplate;
(function (PromptTemplate) {
    PromptTemplate["DIARY_RESPONSE"] = "diary_response";
    PromptTemplate["CRISIS_DETECTION"] = "crisis_detection";
    PromptTemplate["EMOTION_ANALYSIS"] = "emotion_analysis";
 ...
 * 获取系统提示词
 */
export function getSystemPrompt(template = PromptTemplate.DIARY_RESPONSE) {
    switch (template) {
